...
# previsao_eleitoral_desafio_ds documentation build
...
from previsao_eleitoral_desafio_ds import __version__ as release

# -- Project information -----------------------------------------------------

project = "previsao_eleitoral_desafio_ds"
author = "Kedro"
...
htmlhelp_basename = "previsao_eleitoral_desafio_dsdoc"
...
latex_documents = [
    (
        master_doc,
        "previsao_eleitoral_desafio_ds.tex",
        "previsao_eleitoral_desafio_ds Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "previsao_eleitoral_desafio_ds",
        "Project previsao_eleitoral_desafio_ds codebase.",
        "Data-Science",
    )
]
